...
#ifndef FLATBUFFERS_GENERATED_SIGMFWIFI_WIFI_H_
#define FLATBUFFERS_GENERATED_SIGMFWIFI_WIFI_H_
...
struct DescrT : public flatbuffers::NativeTable {
  ...
  std::shared_ptr<wifi::GlobalT> global{};
  std::shared_ptr<wifi::AnnotationT> annotation{};
  std::shared_ptr<wifi::CaptureT> capture{};
};
...
struct Descr FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const wifi::Global *global() const {
    return GetPointer<const wifi::Global *>(VT_GLOBAL);
  }
  const wifi::Annotation *annotation() const {
    return GetPointer<const wifi::Annotation *>(VT_ANNOTATION);
  }
  const wifi::Capture *capture() const {
    return GetPointer<const wifi::Capture *>(VT_CAPTURE);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct DescrBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_global(flatbuffers::Offset<wifi::Global> global) {
    fbb_.AddOffset(Descr::VT_GLOBAL, global);
  }
  void add_annotation(flatbuffers::Offset<wifi::Annotation> annotation) {
    fbb_.AddOffset(Descr::VT_ANNOTATION, annotation);
  }
  void add_capture(flatbuffers::Offset<wifi::Capture> capture) {
...
inline flatbuffers::Offset<Descr> CreateDescr(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<wifi::Global> global = 0,
    flatbuffers::Offset<wifi::Annotation> annotation = 0,
    flatbuffers::Offset<wifi::Capture> capture = 0) {
...
inline void Descr::UnPackTo(DescrT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = global(); if (_e) _o->global = std::shared_ptr<wifi::GlobalT>(_e->UnPack(_resolver)); }
  { auto _e = annotation(); if (_e) _o->annotation = std::shared_ptr<wifi::AnnotationT>(_e->UnPack(_resolver)); }
  { auto _e = capture(); if (_e) _o->capture = std::shared_ptr<wifi::CaptureT>(_e->UnPack(_resolver)); }
}
...
inline const flatbuffers::TypeTable *DescrTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    wifi::GlobalTypeTable,
    wifi::AnnotationTypeTable,
    wifi::CaptureTypeTable
  };
  static const char * const names[] = {
    "global",
    "annotation",
...
#endif  // FLATBUFFERS_GENERATED_SIGMFWIFI_WIFI_H_
