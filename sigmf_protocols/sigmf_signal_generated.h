...
#ifndef FLATBUFFERS_GENERATED_SIGMFSIGNAL_SIGNAL_H_
#define FLATBUFFERS_GENERATED_SIGMFSIGNAL_SIGNAL_H_
...
inline flatbuffers::Offset<signal_detail> Createsignal_detailDirect(
  ...
  return signal::Createsignal_detail(
      _fbb,
      type__,
      mod_class__,
      standard__,
...
inline flatbuffers::Offset<signal_emitter> Createsignal_emitterDirect(
  ...
  return signal::Createsignal_emitter(
      _fbb,
      seid,
      manufacturer__,
      power_tx,
...
struct AnnotationT : public flatbuffers::NativeTable {
  ...
  std::shared_ptr<signal::signal_detailT> detail{};
  std::shared_ptr<signal::signal_emitterT> emitter{};
};
...
struct Annotation FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const signal::signal_detail *detail() const {
    return GetPointer<const signal::signal_detail *>(VT_DETAIL);
  }
  const signal::signal_emitter *emitter() const {
    return GetPointer<const signal::signal_emitter *>(VT_EMITTER);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct AnnotationBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_detail(flatbuffers::Offset<signal::signal_detail> detail) {
    fbb_.AddOffset(Annotation::VT_DETAIL, detail);
  }
  void add_emitter(flatbuffers::Offset<signal::signal_emitter> emitter) {
...
inline flatbuffers::Offset<Annotation> CreateAnnotation(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<signal::signal_detail> detail = 0,
    flatbuffers::Offset<signal::signal_emitter> emitter = 0) {
...
struct DescrT : public flatbuffers::NativeTable {
  ...
  std::shared_ptr<signal::GlobalT> global{};
  std::shared_ptr<signal::AnnotationT> annotation{};
  std::shared_ptr<signal::CaptureT> capture{};
};
...
struct Descr FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const signal::Global *global() const {
    return GetPointer<const signal::Global *>(VT_GLOBAL);
  }
  const signal::Annotation *annotation() const {
    return GetPointer<const signal::Annotation *>(VT_ANNOTATION);
  }
  const signal::Capture *capture() const {
    return GetPointer<const signal::Capture *>(VT_CAPTURE);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct DescrBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_global(flatbuffers::Offset<signal::Global> global) {
    fbb_.AddOffset(Descr::VT_GLOBAL, global);
  }
  void add_annotation(flatbuffers::Offset<signal::Annotation> annotation) {
    fbb_.AddOffset(Descr::VT_ANNOTATION, annotation);
  }
  void add_capture(flatbuffers::Offset<signal::Capture> capture) {
...
inline flatbuffers::Offset<Descr> CreateDescr(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<signal::Global> global = 0,
    flatbuffers::Offset<signal::Annotation> annotation = 0,
    flatbuffers::Offset<signal::Capture> capture = 0) {
...
inline void Annotation::UnPackTo(AnnotationT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = detail(); if (_e) _o->detail = std::shared_ptr<signal::signal_detailT>(_e->UnPack(_resolver)); }
  { auto _e = emitter(); if (_e) _o->emitter = std::shared_ptr<signal::signal_emitterT>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<Annotation> CreateAnnotation(flatbuffers::FlatBufferBuilder &_fbb, const AnnotationT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return signal::CreateAnnotation(
      _fbb,
      _detail,
      _emitter);
}
...
inline void Descr::UnPackTo(DescrT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = global(); if (_e) _o->global = std::shared_ptr<signal::GlobalT>(_e->UnPack(_resolver)); }
  { auto _e = annotation(); if (_e) _o->annotation = std::shared_ptr<signal::AnnotationT>(_e->UnPack(_resolver)); }
  { auto _e = capture(); if (_e) _o->capture = std::shared_ptr<signal::CaptureT>(_e->UnPack(_resolver)); }
}
...
inline const flatbuffers::TypeTable *AnnotationTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    signal::signal_detailTypeTable,
    signal::signal_emitterTypeTable
  };
  static const char * const names[] = {
    "detail",
    "emitter"
...
inline const flatbuffers::TypeTable *DescrTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    signal::GlobalTypeTable,
    signal::AnnotationTypeTable,
    signal::CaptureTypeTable
  };
  static const char * const names[] = {
    "global",
    "annotation",
...
#endif  // FLATBUFFERS_GENERATED_SIGMFSIGNAL_SIGNAL_H_
