...
struct DescrT : public flatbuffers::NativeTable {
  ...
  std::shared_ptr<antenna::GlobalT> global{};
  std::shared_ptr<antenna::AnnotationT> annotation{};
  std::shared_ptr<antenna::CaptureT> capture{};
};
...
inline void Descr::UnPackTo(DescrT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = global(); if (_e) _o->global = std::shared_ptr<antenna::GlobalT>(_e->UnPack(_resolver)); }
  { auto _e = annotation(); if (_e) _o->annotation = std::shared_ptr<antenna::AnnotationT>(_e->UnPack(_resolver)); }
  { auto _e = capture(); if (_e) _o->capture = std::shared_ptr<antenna::CaptureT>(_e->UnPack(_resolver)); }
}
